...
(cl-macrolet ((color (name) (intern (concat "hannover-night-color-" (symbol-name name))))
  ...
  (cl-flet ((box (height color)
      ...
      (custom-theme-set-faces
       ...
       `(isearch ((t (:background ,(color fg) :foreground ,(color bg)))))
       ...
       `(magit-diff-hunk-heading ((t (:background ,(shade (color grey) 0.5) :extend t))))
       ...
       `(magit-diff-removed ((t (:background ,(mix (color 1-red) (color 2-red) 0.8)))))
